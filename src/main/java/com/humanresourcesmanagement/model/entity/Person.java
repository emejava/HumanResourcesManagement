...
@NamedQueries({@NamedQuery(
        name = "person.findAllActive",query = "SELECT p FROM personEntity p WHERE p.status=:Active"),
        @NamedQuery(
...
public class Person {
    ...
    @Pattern(regexp = "[0-9]", message = "لطفا از اعداد انگلیسی استفاده کنید")
    @Column(name = "phoneNo",columnDefinition = "NVARCHAR2(11)")
    ...
    @Pattern(regexp = "[0-9]", message = "لطفا از اعداد انگلیسی استفاده کنید")
    @Column(name = "landLineNo",columnDefinition = "NVARCHAR2(11)")
    ...
    public Person(
        ...
        BirthCertificateCode = birthCertificateCode;
