...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../HCJ/CSS/dashboardTwoPage.css">
    <title>Sign Up</title>
</head>
<body>
<div class="container" dir="rtl">
    ...
    <div class="main">
        ...
        <div class="container1" dir="rtl">
            ...
            <form action="application/signUp.do" method="post">
        ...
        <script src="../HCJ/JAVASCRIPT/nextBTN.js"></script>
    </div>
</div>
</div>
